...
function algorithm50(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # y: ml2, full, L7: ml1, lower_triangular, L15: ml3, lower_triangular, tmp70: ml0, full
    # tmp72 = (tmp70 L15^-1)
    trsm!('R', 'L', 'N', 'N', 1.0, ml3, ml0)

    # y: ml2, full, L7: ml1, lower_triangular, tmp72: ml0, full
    # tmp68 = (L7^-1 y)
    trsv!('L', 'N', 'N', ml1, ml2)

    # tmp72: ml0, full, tmp68: ml2, full
